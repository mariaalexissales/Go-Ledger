...
export const IP_RAMP_DARK: readonly string[] = [
  '#8199F8', '#8185F8', '#9181F8', '#A381F8', '#B781F8', '#CB81F8',
  '#DF81F8', '#F281F8', '#F881EA', '#F881D9', '#F881C5', '#F881B1',
  '#AFBFFD', '#AFB2FD', '#B9AFFD', '#C5AFFD', '#D2AFFD', '#DFAFFD',
  '#ECAFFD', '#F9AFFD', '#FDAFF4', '#FDAFE8', '#FDAFDB', '#FDAFCE',
]

export const IP_RAMP_LIGHT: readonly string[] = [
  '#2A43A7', '#2A2EA7', '#3B2AA7', '#4D2AA7', '#622AA7', '#772AA7',
  '#8C2AA7', '#A12AA7', '#A72A99', '#A72A86', '#A72A71', '#A72A5C',
  '#182F8B', '#181C8B', '#28188B', '#39188B', '#4C188B', '#5F188B',
  '#72188B', '#85188B', '#8B187D', '#8B186C', '#8B1859', '#8B1846',
]
